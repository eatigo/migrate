...
[![GoDoc](https://godoc.org/github.com/eatigo/migrate?status.svg)](https://godoc.org/github.com/eatigo/migrate)
...
Looking for [v1](https://github.com/eatigo/migrate/tree/v1)?
...
Database drivers run migrations. [Add a new database?](database/driver.go)
  ...
  * [Neo4j](database/neo4j) ([todo #167](https://github.com/eatigo/migrate/issues/167))
  * [MongoDB](database/mongodb) ([todo #169](https://github.com/eatigo/migrate/issues/169))
  * [CrateDB](database/crate) ([todo #170](https://github.com/eatigo/migrate/issues/170))
  * [Shell](database/shell) ([todo #171](https://github.com/eatigo/migrate/issues/171))
...
([brew todo #156](https://github.com/eatigo/migrate/issues/156))
 ...
 * Only import the drivers you need.
   (check [dependency_tree.txt](https://github.com/eatigo/migrate/releases) for each driver)
 * To help prevent database corruptions, it supports graceful stops via `GracefulStop chan bool`.
 * Bring your own logger.
 * Uses `io.Reader` streams internally for low memory overhead.
 * Thread-safe and no goroutine leaks.

__[Go Documentation](https://godoc.org/github.com/eatigo/migrate)__

```go
import (
    "github.com/eatigo/migrate"
    _ "github.com/eatigo/migrate/database/postgres"
    _ "github.com/eatigo/migrate/source/github"
)
...
import (
    ...
    _ "github.com/lib/pq"
    "github.com/eatigo/migrate"
    "github.com/eatigo/migrate/database/postgres"
