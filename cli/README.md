...
```
$ go get -u -d github.com/eatigo/migrate/cli github.com/lib/pq
$ go build -tags 'postgres' -o /usr/local/bin/migrate github.com/eatigo/migrate/cli
```
...
([todo #156](https://github.com/eatigo/migrate/issues/156))
...
[Release Downloads](https://github.com/eatigo/migrate/releases)

```
$ curl -L https://github.com/eatigo/migrate/releases/download/$version/migrate.$platform-amd64.tar.gz | tar xvz
```
